...
const Json2 = (props) => {
  let config = {
      ...
      const test =props.patientList.caracCliniques;
      return (
        <View style={styles.container2}><ScrollView>
      <WavyHeader customStyles={styles.svgCurve} />
      <Text style={styles.headerText}>Caractéristiques cliniques du cas</Text>
...
<FormButton title="Suivant" onPress={() => { props.navigation.navigate("Json7") }} />
</ScrollView></View>
