...
const Json2 = (props) => {
  let config = {
      ...
      <Text style={styles.headerText}>Examens Biologiques</Text>
      ...
      <View style={styles.container1}>
            ...
            <Text style={styles.name}>{key}</Text>
              
              {
                      ...
                      <View>{Object.keys(test[setNom][key]).length!==0&&
...
<FormButton title="Suivant" onPress={() => { props.navigation.navigate("Json9") }} />
</ScrollView></View>
