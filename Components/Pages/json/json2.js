...
const Json2 = (props) => {
  let config = {
      ...
      const test =props.patientList.expoRisque;
      return (
        <View style={styles.container2}><ScrollView>
      <WavyHeader customStyles={styles.svgCurve} />
      <Text style={styles.headerText}>Expositions à Risque</Text>
...
<FormButton title="Suivant" onPress={() => { props.navigation.navigate("Json3") }} />
</ScrollView></View>
